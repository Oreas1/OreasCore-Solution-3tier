MainModule
    .controller("PurchaseNoteActionIndexCtlr", function ($scope, $window, $http) {   
        ...
        init_Operations($scope, $http,
            '/QC/Testing/PurchaseNoteActionLoad', //--v_Load
            '/QC/Testing/PurchaseNoteActionGet', // getrow
            '/QC/Testing/PurchaseNoteActionPost' // PostRow
        );

        init_ViewSetup($scope, $http, '/QC/Testing/GetInitializedPurchaseNoteAction');
        ...
        $scope.GotoReport = function (id) {
            $window.open('/QC/Testing/GetPurchaseNoteActionReport?rn=Purchase Note Label&id=' + id);
        };
