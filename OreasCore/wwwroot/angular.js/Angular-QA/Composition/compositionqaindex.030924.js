MainModule
    .controller("CompositionMasterCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/QA/Composition/CompositionMasterLoad', //--v_Load
            '/QA/Composition/CompositionMasterGet', // getrow
            '/QA/Composition/CompositionMasterPost' // PostRow
        );

        init_ViewSetup($scope, $http, '/QA/Composition/GetInitializedComposition');
    ...
    .controller("CompositionDetailRawMasterCtlr", function ($scope, $http) {
        ...
        $scope.$on('init_CompositionDetailRawMasterCtlr', function (e, itm) {
            ...
            init_Report($scope, itm.Reports, '/QA/Composition/GetCompositionReport'); 
            $scope.CompositionFilterList = itm.Otherdata === null ? [] : itm.Otherdata.CompositionFilterList;
        });

       init_Operations($scope, $http,
            '/QA/Composition/CompositionDetailRawMasterLoad', //--v_Load
            '/QA/Composition/CompositionDetailRawMasterGet', // getrow
            '/QA/Composition/CompositionDetailRawMasterPost' // PostRow
        );
    ...
    .controller("CompositionDetailRawDetailCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/QA/Composition/CompositionDetailRawDetailLoad', //--v_Load
            '/QA/Composition/CompositionDetailRawDetailGet', // getrow
            '/QA/Composition/CompositionDetailRawDetailPost' // PostRow
        );
    ...
    .controller("CompositionDetailCouplingMasterCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/QA/Composition/CompositionDetailCouplingMasterLoad', //--v_Load
            '/QA/Composition/CompositionDetailCouplingMasterGet', // getrow
            '/QA/Composition/CompositionDetailCouplingMasterPost' // PostRow
        );
    ...
    .controller("CompositionDetailCouplingDetailPackagingMasterCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/QA/Composition/CompositionDetailCouplingDetailPackagingMasterLoad', //--v_Load
            '/QA/Composition/CompositionDetailCouplingDetailPackagingMasterGet', // getrow
            '/QA/Composition/CompositionDetailCouplingDetailPackagingMasterPost' // PostRow
        );
    ...
    .controller("CompositionDetailCouplingDetailPackagingDetailMasterCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/QA/Composition/CompositionDetailCouplingDetailPackagingDetailMasterLoad', //--v_Load
            '/QA/Composition/CompositionDetailCouplingDetailPackagingDetailMasterGet', // getrow
            '/QA/Composition/CompositionDetailCouplingDetailPackagingDetailMasterPost' // PostRow
        );
    ...
    .controller("CompositionDetailCouplingDetailPackagingDetailDetailCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/QA/Composition/CompositionDetailCouplingDetailPackagingDetailDetailLoad', //--v_Load
            '/QA/Composition/CompositionDetailCouplingDetailPackagingDetailDetailGet', // getrow
            '/QA/Composition/CompositionDetailCouplingDetailPackagingDetailDetailPost' // PostRow
        );
