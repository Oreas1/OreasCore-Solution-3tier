MainModule
    .controller("CompositionFilterPolicyMasterCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/QA/SetUp/CompositionFilterPolicyMasterLoad', //--v_Load
            '/QA/SetUp/CompositionFilterPolicyMasterGet', // getrow
            '/QA/SetUp/CompositionFilterPolicyMasterPost' // PostRow
        );

        init_ViewSetup($scope, $http, '/QA/SetUp/GetInitializedCompositionFilterPolicy');
    ...
    .controller("CompositionFilterPolicyDetailCtlr", function ($scope, $http) {
       ...
       init_Operations($scope, $http,
            '/QA/SetUp/CompositionFilterPolicyDetailLoad', //--v_Load
            '/QA/SetUp/CompositionFilterPolicyDetailGet', // getrow
            '/QA/SetUp/CompositionFilterPolicyDetailPost' // PostRow
        );
