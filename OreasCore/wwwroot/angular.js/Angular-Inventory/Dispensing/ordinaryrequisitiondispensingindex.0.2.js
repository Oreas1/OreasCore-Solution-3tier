MainModule
    .controller("OrdinaryRequisitionDispensingMasterCtlr", function ($scope, $http) {
        ...
        $scope.AutoIssuanceRequest = function (BMR_RawItemID, BMR_PackagingItemID, BMR_AdditionalItemID, OR_ItemID, scope) {
            ...
            $http({
                method: "POST", url: '/Inventory/Dispensing/OrdinaryStockIssuanceReservationItemPost', async: false, params: { BMR_RawItemID: BMR_RawItemID, BMR_PackagingItemID: BMR_PackagingItemID, BMR_AdditionalItemID: BMR_AdditionalItemID, OR_ItemID: OR_ItemID, operation: 'Save New' }, headers: { 'X-Requested-With': 'XMLHttpRequest', 'NOSpinner': true, 'RequestVerificationToken': $scope.antiForgeryToken }
