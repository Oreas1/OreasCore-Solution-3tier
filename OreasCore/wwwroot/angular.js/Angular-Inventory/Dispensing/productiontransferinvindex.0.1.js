MainModule
    .controller("ProductionTransferMasterCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/Inventory/Dispensing/ProductionTransferMasterLoad', //--v_Load
            '', // getrow
            '' // PostRow
        );

        init_ViewSetup($scope, $http, '/Inventory/Dispensing/GetInitializedProductionTransfer');
        $scope.init_ViewSetup_Response = function (data) {
            if (data.find(o => o.Controller === 'ProductionTransferMasterCtlr') != undefined) {                
                ...
                $scope.FilterByLoad = 'byNotReceived';
        ...
        $scope.GetRowResponse = function (data, operation) {            
            $scope.tbl_Pro_ProductionTransferMaster = data;
            $scope.tbl_Pro_ProductionTransferMaster.DocDate = new Date(data.DocDate);   
        };
    ...
    .controller("ProductionTransferDetailCtlr", function ($scope, $http) {
       ...
       init_Operations($scope, $http,
            '/Inventory/Dispensing/ProductionTransferDetailLoad', //--v_Load
            '/Inventory/Dispensing/ProductionTransferDetailGet', // getrow
            '/Inventory/Dispensing/ProductionTransferDetailPost' // PostRow
        );
        ...
        $scope.tbl_Pro_ProductionTransferDetail = {
            ...
            'Received': true, 'ReceivedBy': null, 'ReceivedDate': null,
            'CreatedBy': '', 'CreatedDate': '', 'ModifiedBy': '', 'ModifiedDate': ''
        };
