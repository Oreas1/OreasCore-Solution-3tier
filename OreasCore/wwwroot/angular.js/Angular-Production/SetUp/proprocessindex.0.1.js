MainModule
    .controller("ProProcessMasterCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/Production/SetUp/ProProcessMasterLoad', //--v_Load
            '/Production/SetUp/ProProcessMasterGet', // getrow
            '/Production/SetUp/ProProcessMasterPost' // PostRow
        );
  
        init_ViewSetup($scope, $http, '/Production/SetUp/GetInitializedProProcess?Caller=' + $scope.caller);
    ...
    .controller("ProProcessDetailCtlr", function ($scope, $http) {
        ...
        init_Operations($scope, $http,
            '/Production/SetUp/ProProcessDetailLoad', //--v_Load
            '/Production/SetUp/ProProcessDetailGet', // getrow
            '/Production/SetUp/ProProcessDetailPost' // PostRow
        );
