...
namespace OreasCore.Areas.Production.Controllers
{
    ...
    public class BMRController : Controller
    {
            ...
            return Json(
                new List<Init_ViewSetupStructure>()
                {
                    new Init_ViewSetupStructure()
                    {
                        ...
                        Reports = null,
                        Privilege = await db.GetUserAuthorizatedOnOperationAsync("Production", User.Identity.Name, "BMR"),
                        Otherdata = null
                    },
                    new Init_ViewSetupStructure()
                    {
            ...
            return Json(
                new List<Init_ViewSetupStructure>()
                {
                    new Init_ViewSetupStructure()
                    {
                        ...
                        Reports = null,
                        Privilege = await db.GetUserAuthorizatedOnOperationAsync("Production", User.Identity.Name, "BMR Additional"),
                        Otherdata = null
                    },
                    new Init_ViewSetupStructure()
                    {
        ...
        #region OrderNote Production

        [MyAuthorization]
        public async Task<IActionResult> GetInitializedOrderNoteProductionAsync([FromServices] IAuthorizationScheme db, [FromServices] IOrderNoteProduction db2)
        {
            return Json(
                new List<Init_ViewSetupStructure>()
                {
                    new Init_ViewSetupStructure()
                    {
                        Controller = "OrderNoteProductionCtlr",
                        WildCard =  db2.GetWCLOrderNoteDetail(),
                        LoadByCard = db2.GetWCLBOrderNoteDetail(),
                        Reports = null,
                        Privilege = await db.GetUserAuthorizatedOnOperationAsync("Production", User.Identity.Name, "Order Note Production Order"),
                        Otherdata = null
                    },
                    new Init_ViewSetupStructure()
                    {
                        Controller = "OrderNoteProductionOrderCtlr",
                        WildCard =  null,
                        LoadByCard = null,
                        Reports = null,
                        Privilege = null,
        ...
        [MyAuthorization(FormName = "Order Note Production Order", Operation = "CanView")]
        public IActionResult OrderNoteProductionIndex()
        {
            return View();
        }
        ...
        [AjaxOnly]
        [MyAuthorization(FormName = "Order Note Production Order", Operation = "CanView")]
        public async Task<IActionResult> OrderNoteProductionLoad([FromServices] IOrderNoteProduction db,
            int CurrentPage = 1, int MasterID = 0,
            string FilterByText = null, string FilterValueByText = null,
            string FilterByNumberRange = null, int FilterValueByNumberRangeFrom = 0, int FilterValueByNumberRangeTill = 0,
            string FilterByDateRange = null, DateTime? FilterValueByDateRangeFrom = null, DateTime? FilterValueByDateRangeTill = null,
        ...
        [AjaxOnly]
        [MyAuthorization(FormName = "Order Note Production Order", Operation = "CanView")]
        public async Task<IActionResult> OrderNoteProductionOrderLoad([FromServices] IOrderNoteProduction db,
            int CurrentPage = 1, int MasterID = 0,
            string FilterByText = null, string FilterValueByText = null,
            string FilterByNumberRange = null, int FilterValueByNumberRangeFrom = 0, int FilterValueByNumberRangeTill = 0,
            string FilterByDateRange = null, DateTime? FilterValueByDateRangeFrom = null, DateTime? FilterValueByDateRangeTill = null,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        [MyAuthorization(FormName = "Order Note Production Order", Operation = "CanPost")]
        public async Task<string> OrderNoteProductionOrderPost([FromServices] IOrderNoteProduction db, [FromBody] tbl_Inv_OrderNoteDetail_ProductionOrder tbl_Inv_OrderNoteDetail_ProductionOrder, string operation = "")
        {
            if (ModelState.IsValid)
                return await db.PostProductionOrder(tbl_Inv_OrderNoteDetail_ProductionOrder, operation, User.Identity.Name);
            else
                return CustomMessage.ModelValidationFailedMessage(ModelState);
        }

        [MyAuthorization(FormName = "Order Note Production Order", Operation = "CanView")]
        public async Task<IActionResult> OrderNoteProductionOrderGet([FromServices] IOrderNoteProduction db, int ID)
        {
            return Json(await db.GetProductionOrder(ID), new Newtonsoft.Json.JsonSerializerSettings());
        }

        [MyAuthorization(FormName = "Order Note Production Order", Operation = "CanView")]
        public async Task<IActionResult> BMRAvailabilityGet([FromServices] IOrderNoteProduction db, int ID)
        {
        ...
        [MyAuthorization]
        public async Task<IActionResult> GetInitializedProductionTransferAsync([FromServices] IAuthorizationScheme db, [FromServices] IProductionTransfer db2, [FromServices] IInventoryList db3)
        {
            return Json(
                new List<Init_ViewSetupStructure>()
                {
                    ...
                    new Init_ViewSetupStructure()
                    {
                        ...
                        Reports = db2.GetRLProductionTransfer(),
                        Privilege = null,
                        Otherdata = null
                    }
                }
        ...
        [AjaxOnly]
        [MyAuthorization(FormName = "Production Transfer", Operation = "CanView")]
        public async Task<IActionResult> ProductionTransferMasterLoad([FromServices] IProductionTransfer db,
            int CurrentPage = 1, int MasterID = 0,
            string FilterByText = null, string FilterValueByText = null,
            string FilterByNumberRange = null, int FilterValueByNumberRangeFrom = 0, int FilterValueByNumberRangeTill = 0,
            string FilterByDateRange = null, DateTime? FilterValueByDateRangeFrom = null, DateTime? FilterValueByDateRangeTill = null,
        ...
        public async Task<string> ProductionTransferMasterPost([FromServices] IProductionTransfer db, [FromBody] tbl_Pro_ProductionTransferMaster tbl_Pro_ProductionTransferMaster, string operation = "")
        {
            if (ModelState.IsValid)
                return await db.PostProductionTransferMaster(tbl_Pro_ProductionTransferMaster, operation, User.Identity.Name);
            else
                return CustomMessage.ModelValidationFailedMessage(ModelState);
        }

        [MyAuthorization(FormName = "Production Transfer", Operation = "CanView")]
        public async Task<IActionResult> ProductionTransferMasterGet([FromServices] IProductionTransfer db, int ID)
        {
            return Json(await db.GetProductionTransferMaster(ID), new Newtonsoft.Json.JsonSerializerSettings());
        }
        ...
        [AjaxOnly]
        [MyAuthorization(FormName = "Production Transfer", Operation = "CanView")]
        public async Task<IActionResult> ProductionTransferDetailLoad([FromServices] IProductionTransfer db,
            int CurrentPage = 1, int MasterID = 0,
            string FilterByText = null, string FilterValueByText = null,
            string FilterByNumberRange = null, int FilterValueByNumberRangeFrom = 0, int FilterValueByNumberRangeTill = 0,
            string FilterByDateRange = null, DateTime? FilterValueByDateRangeFrom = null, DateTime? FilterValueByDateRangeTill = null,
        ...
        [ValidateAntiForgeryToken]
        [MyAuthorization(FormName = "Production Transfer", Operation = "CanPost")]
        public async Task<string> ProductionTransferDetailPost([FromServices] IProductionTransfer db, [FromBody] tbl_Pro_ProductionTransferDetail tbl_Pro_ProductionTransferDetail, string operation = "")
        {
            if (ModelState.IsValid)
        ...
        [MyAuthorization(FormName = "Production Transfer", Operation = "CanView")]
        public async Task<IActionResult> ProductionTransferDetailGet([FromServices] IProductionTransfer db, int ID)
        {
        ...
        [MyAuthorization(FormName = "Production Transfer", Operation = "CanViewReport")]
        public async Task<IActionResult> GetProductionTransferReport([FromServices] IProductionTransfer db, string rn = null, int id = 0, int SerialNoFrom = 0, int SerialNoTill = 0, DateTime? datefrom = null, DateTime? datetill = null, string SeekBy = "", string GroupBy = "", string OrderBy = "", int GroupID = 0)
        {
            return File(await db.GetPDFFileAsync(rn, id, SerialNoFrom, SerialNoTill, datefrom, datetill, SeekBy, GroupBy, OrderBy, "", GroupID, User.Identity.Name), rn.ToLower().Contains("excel") ? "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" : "application/pdf");
        }
