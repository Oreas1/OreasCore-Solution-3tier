...
namespace OreasCore.Areas.Production.Controllers
{
    ...
    public class SetUpController : Controller
    {
            ...
            return Json(
                new List<Init_ViewSetupStructure>()
                {
                    new Init_ViewSetupStructure()
                    {
                        ...
                        LoadByCard = null,
                        Reports = null,
                        Privilege = await db.GetUserAuthorizatedOnOperationAsync("Production", User.Identity.Name, "Composition Filter Policy"),
                        Otherdata = new {
            ...
            return Json(
                new List<Init_ViewSetupStructure>()
                {
                    new Init_ViewSetupStructure()
                    {
                        ...
                        Reports = null,
                        Privilege = await db.GetUserAuthorizatedOnOperationAsync("Production", User.Identity.Name, "Procedure"),
                        Otherdata = null
                    }
                }
                , new Newtonsoft.Json.JsonSerializerSettings()
        ...
        [MyAuthorization]
        public async Task<IActionResult> GetInitializedProProcessAsync([FromServices] IAuthorizationScheme db, [FromServices] IProProcess db2, [FromServices] IProductionList db3, string Caller = "")
        {
            return Json(
                new List<Init_ViewSetupStructure>()
                {
                    new Init_ViewSetupStructure()
                    {
                        Controller = "ProProcessMasterCtlr",
                        WildCard = db2.GetWCLProProcessMaster(),
                        LoadByCard = null,
                        Reports = null,
                        Privilege = await db.GetUserAuthorizatedOnOperationAsync("Production", User.Identity.Name, "Process"),
                        Otherdata = new { ProProcedureList = await db3.GetProProcedureListAsync("byBMRBPR",Caller) }
                    },
                    new Init_ViewSetupStructure()
                    {
                        Controller = "ProProcessDetailCtlr",
                        WildCard = db2.GetWCLProProcessDetail(),
                        Reports = null,
                        Privilege = null,
                        Otherdata = null
                    }
        ...
        [MyAuthorization(FormName = "Process", Operation = "CanView")]
        public IActionResult ProProcessIndex()
        {
            return View();
        }
        ...
        [AjaxOnly]
        [MyAuthorization(FormName = "Process", Operation = "CanView")]
        public async Task<IActionResult> ProProcessMasterLoad([FromServices] IProProcess db, string Caller = "",
            int CurrentPage = 1, int MasterID = 0,
            string FilterByText = null, string FilterValueByText = null,
            string FilterByNumberRange = null, int FilterValueByNumberRangeFrom = 0, int FilterValueByNumberRangeTill = 0,
            string FilterByDateRange = null, DateTime? FilterValueByDateRangeFrom = null, DateTime? FilterValueByDateRangeTill = null,
        ...
        {
            PagedData<object> pageddata =
                await db.LoadProProcessMaster(Caller, CurrentPage, MasterID, FilterByText, FilterValueByText,
                FilterByNumberRange, FilterValueByNumberRangeFrom, FilterValueByNumberRangeTill,
                FilterByDateRange, FilterValueByDateRangeFrom, FilterValueByDateRangeTill,
                FilterByLoad);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        [MyAuthorization(FormName = "Process", Operation = "CanPost")]
        public async Task<string> ProProcessMasterPost([FromServices] IProProcess db, [FromBody] tbl_Pro_ProcessMaster tbl_Pro_ProcessMaster, string operation = "")
        {
            if (ModelState.IsValid)
                return await db.PostProProcessMaster(tbl_Pro_ProcessMaster, operation, User.Identity.Name);
            else
                return CustomMessage.ModelValidationFailedMessage(ModelState);
        }

        [MyAuthorization(FormName = "Process", Operation = "CanView")]
        public async Task<IActionResult> ProProcessMasterGet([FromServices] IProProcess db, int ID)
        {
            return Json(await db.GetProProcessMaster(ID), new Newtonsoft.Json.JsonSerializerSettings());
        }
        ...
        [AjaxOnly]
        [MyAuthorization(FormName = "Process", Operation = "CanView")]
        public async Task<IActionResult> ProProcessDetailLoad([FromServices] IProProcess db,
            int CurrentPage = 1, int MasterID = 0,
            string FilterByText = null, string FilterValueByText = null,
            string FilterByNumberRange = null, int FilterValueByNumberRangeFrom = 0, int FilterValueByNumberRangeTill = 0,
            string FilterByDateRange = null, DateTime? FilterValueByDateRangeFrom = null, DateTime? FilterValueByDateRangeTill = null,
        ...
        {
            PagedData<object> pageddata =
                await db.LoadProProcessDetail(CurrentPage, MasterID, FilterByText, FilterValueByText,
                FilterByNumberRange, FilterValueByNumberRangeFrom, FilterValueByNumberRangeTill,
                FilterByDateRange, FilterValueByDateRangeFrom, FilterValueByDateRangeTill,
                FilterByLoad);
        ...
        [ValidateAntiForgeryToken]
        [MyAuthorization(FormName = "Process", Operation = "CanPost")]
        public async Task<string> ProProcessDetailPost([FromServices] IProProcess db, [FromBody] tbl_Pro_ProcessDetail tbl_Pro_ProcessDetail, string operation = "")
        {
            if (ModelState.IsValid)
                return await db.PostProProcessDetail(tbl_Pro_ProcessDetail, operation, User.Identity.Name);
            else
                return CustomMessage.ModelValidationFailedMessage(ModelState);
        }

        [MyAuthorization(FormName = "Process", Operation = "CanView")]
        public async Task<IActionResult> ProProcessDetailGet([FromServices] IProProcess db, int ID)
        {
            return Json(await db.GetProProcessDetail(ID), new Newtonsoft.Json.JsonSerializerSettings());
        }
